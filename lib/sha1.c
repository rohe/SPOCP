...
static void
sha1_process(struct sha1_context *ctx, uint8 data[64])
{
...
void
sha1_update(struct sha1_context *ctx, uint8 * input, uint32 length)
{
	uint32          left, fill;
...
void
sha1_finish(struct sha1_context *ctx, uint8 digest[16])
{
	uint32          last, padn;
	uint8           msglen[8];
