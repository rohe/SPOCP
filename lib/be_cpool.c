 ...
 * pointer to the connection pool \return A becon_t struct representing an
 * active connection 
 */
becon_t        *
becon_push(octet_t * arg, closefn * close, void *con, becpool_t * bcp)
{
	becon_t        *bc;
...
becon_t        *
becon_get(octet_t * arg, becpool_t * bcp)
{
	becon_t        *bc;
