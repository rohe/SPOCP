...
spocp_result_t strcasematch_test( octet_t *arg, becpool_t *b, octet_t *blob  ) ;
...
/* 
  First argument is urn name
  second argument the function to call for this backend
  third argument is where cachetime will be placed has to be 0 (zero) */
