 ...
 * #define START 0
 * 
 * #define DEF_LINK 4 #define TTIME 1
 * 
 * #define FORWARD 1 #define BACKWARD 2
 * 
 * #define QUERY 0x01 #define LIST 0x02 #define ADD 0x04 #define REMOVE 0x08
 * #define BEGIN 0x10 #define ALIAS 0x20 #define COPY 0x40
 * 
 * #define SUBTREE 0x04 #define ONELEVEL 0x02 #define BASE 0x01 
 */
...
typedef struct _element {
	...
	union {
		atom_t         *atom;	/* suffix and prefix is also placed
					 * here */
		struct _list   *list;
		struct _varr   *set;
		struct _range  *range;
...
typedef struct _list {
	unsigned int    hstrlist;	/* hash of the list string, of limit
					 * usage */
	element_t      *head;
} list_t;
